var RedisCli = function(postUrl, token) {
	console.log(token);
	// Constants
	var KEY_UP = 38;
	var KEY_DOWN = 40;
...
$(function() {
    var redisCli = new RedisCli(JSON.parse($('#execute-view-data').text()), document.getElementById('csrf_token').value);
});
